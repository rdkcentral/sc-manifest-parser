...
You can submit your changes for review via that site, by raising an issue in github, (https://github.com/rdkcentral/sc-manifest-parser/issues), and following the sequence below.
...
- create a pull request (https://github.com/rdkcentral/sc-manifest-parser/compare) when the code changes are ready for review.
